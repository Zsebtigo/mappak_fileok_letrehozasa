...
namespace Fileok_mappak_projekt
{
            ...
            while (true)
            {
                ...
                if (fajta == 1)
                {
                    ...
                    if (!(mappa_nev == ""))
                    {
                        ...
                        Console.WriteLine($"\nSikeressen létrehoztad a {mappa_nev} mappát");
                ...
                else if (fajta == 2)
                {
                    ...
                    Console.WriteLine("Itt megadhatsz egy szövegrrészletet a txt");
                    string tartalom = Console.ReadLine();
                    if (!(fajl_nev == ""))
                    {
                        File.WriteAllText($"{fajl_nev}.txt", tartalom);
                        Console.WriteLine($"\nSikeressen létrehoztad a {fajl_nev}.txt filet");
                    }
                    else
                    {
                        break;
                ...
                else if (fajta == 3)
                {
                    ...
                    if (!(csv_nev == ""))
                    {
                        ...
                        Console.WriteLine($"\nSikeressen létrehoztad a {csv_nev}.csv filet");
                ...
                else if (fajta == 4)
                {
                    ...
                    if (!(html_nev == ""))
                    {
                        ...
                        Console.WriteLine($"\nSikeressen létrehoztad a {html_nev}.html filet");
    ...
    background-color:" + szin + @";
                    ...
                    if (!(css_nev == ""))
                    {
                        ...
                        Console.WriteLine($"\nSikeressen létrehoztad a {css_nev}.css filet");
                ...
                else if (fajta == 6)
                {
                    ...
                    if (!(js_nev == ""))
                    {
                        ...
                        Console.WriteLine($"\nSikeressen létrehoztad a {js_nev}.js filet");
